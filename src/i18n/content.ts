...
export const t = {
  es: {
    ...
    meta: {
      ...
      description: 'Casa rural para 8 personas en Bamio con piscina y vistas a la Ría de Arousa. Casa completa. Reserva directa.',
    },
    hero: {
  ...
  en: {
    ...
    meta: {
      ...
      description: 'Rural house for 8 in Bamio with pool and Ría de Arousa views. Whole house. Direct booking.',
    },
    hero: {
  ...
  gl: {
    ...
    meta: {
      title: 'Solpor de Arousa · Casa rural en Bamio, Vilagarcía',
      description: 'Casa rural para 8 persoas en Bamio con piscina e vistas á Ría de Arousa. Casa completa. Reserva directa.',
    },
    hero: {
      eyebrow: 'Casa rural · Bamio, Ría de Arousa',
      title: 'Solpor de Arousa',
